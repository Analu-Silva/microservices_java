package br.edu.atitus.product_services.controllers;
...
import br.edu.atitus.product_services.repositories.ProductRepository;
...
public class OpenProductController {
	...
	public ResponseEntity<ProductEntity> getProduct(
		...
		product.setEnviorement("Product-Srvice running on Port: " + serverPort);
